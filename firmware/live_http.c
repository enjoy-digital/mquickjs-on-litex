...
".grid{display:grid;grid-template-columns:minmax(0,1fr) 330px;gap:12px}.editor,.panel{background:#06080b;border:1px solid #30343a;border-radius:4px;box-shadow:0 0 0 1px #05070a inset}"
".title{display:flex;justify-content:space-between;padding:8px 10px;border-bottom:1px solid #10384d;color:#12bdf2;text-transform:uppercase}"
...
"aside{display:flex;flex-direction:column;gap:10px}.bar{display:flex;gap:7px;flex-wrap:wrap}.bar label{display:flex;align-items:center;gap:6px;color:#8fa3b2}"
...
"pre{white-space:pre-wrap;margin:0;background:#020406;border:1px solid #30343a;border-radius:4px;padding:10px;min-height:58px;overflow:auto;color:#dce8f2}#info{min-height:146px}#log{min-height:132px}"
