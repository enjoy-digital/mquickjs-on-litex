...
"    framebuffer.rect(x, y, 10, 10, 0xffc857);\n"
"  }\n"
"  framebuffer.flush();\n"
"}\n"
...
"    framebuffer.rect(0,y,framebuffer.width,8,c);\\n"
"  }\\n"
"  framebuffer.flush();\\n"
"}\\n`,"
...
"    framebuffer.rect(x,y,4,4,(v<<16)|(((255-v)&255)<<8)|((v*3)&255));\\n"
"  }\\n"
"  framebuffer.flush();\\n"
"}\\n`,"
...
"    framebuffer.rect(x,y,6,6,0x40d9ff);\\n"
"  }\\n"
"  framebuffer.flush();\\n"
"}\\n`};"
