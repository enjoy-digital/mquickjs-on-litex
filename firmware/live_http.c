...
"textarea{display:block;width:100%;height:640px;background:#020406;color:#dce8f2;border:0;outline:0;padding:14px;font:13px/1.45 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;resize:vertical}"
"aside{display:flex;flex-direction:column;gap:10px}.body{padding:10px}.bar{display:grid;grid-template-columns:repeat(3,1fr);gap:7px}.tools{grid-template-columns:repeat(2,1fr)}.slots{grid-template-columns:1fr 1fr 1fr}.params{display:grid;gap:8px}.params label{display:grid;grid-template-columns:58px 1fr;align-items:center;gap:8px;color:#8fa3b2}"
"button,select,input{border:1px solid #30343a;border-radius:4px;background:#080c10;color:#dce8f2;height:34px;padding:0 10px;font:13px sans-serif}button{cursor:pointer;background:#072234;border-color:#0b87bd;color:#e8f8ff}button.secondary{background:#0a0d11;border-color:#30343a;color:#c6d2dc}button.tool{background:#061923;border-color:#12bdf2;color:#12bdf2}button:disabled{opacity:.35;cursor:not-allowed}select{max-width:106px}input[type=range]{width:100%;padding:0}input[type=checkbox]{width:16px;height:16px;padding:0}"
...
"</div></div>"
"<div class='panel'><div class='title'><span>parameters</span><span>live</span></div><div class='body params'>"
...
"</div></div>"
"<div class='panel'><div class='title'><span>console</span><span>log</span></div><pre id='log'>ready</pre></div>"
"</aside></section>"
"<script>"
