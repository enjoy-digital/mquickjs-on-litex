...
| `arty_showcase.js` | Arty demo for people watching the board | Visible LED patterns and timing |
| `sdcard_loader.js` | Arty SDCard auto-boot firmware script | Auto-runs `main.js` from FAT |
...
Run the SDCard auto-boot demo on Arty:
