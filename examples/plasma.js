...
//
// First framebuffer demo: draw a small plasma tile from JavaScript, then
// scale it through the LiteX framebuffer helper so it is visible on HDMI.
...
if (fbWidth === 0 || fbHeight === 0) {
    ...
    var scale  = Math.min(8, (fbWidth / width) >> 0, (fbHeight / height) >> 0);
